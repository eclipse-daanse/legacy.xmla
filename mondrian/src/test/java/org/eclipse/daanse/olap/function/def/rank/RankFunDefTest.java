...
class RankFunDefTest {
    ...
    void testRankWithExpr(Context context) {
        ...
        assertQueryReturns(context.getConnectionWithDefaultRole(),
            ...
            "Axis #0:\n"
                + "{[Store].[Store].[USA].[OR].[Portland].[Store 11], [Time].[1997].[Q2].[6]}\n"
                + "Axis #1:\n"
                + "{[Measures].[Unit Sales]}\n"
                + "{[Measures].[Sales Rank]}\n"
    ...
    void testRankTuplesWithTiedExpr(Context context) {
        assertQueryReturns(context.getConnectionWithDefaultRole(),
            ...
            "Axis #0:\n"
                ...
                + "{[Measures].[Sales Rank]}\n"
                + "Axis #2:\n"
                + "{[Product].[Product].[Drink].[Alcoholic Beverages].[Beer and Wine].[Beer].[Good], [Store].[USA].[OR].[Portland]"
                + ".[Store 11]}\n"
                + "{[Product].[Product].[Drink].[Alcoholic Beverages].[Beer and Wine].[Beer].[Portsmouth], [Store].[USA].[OR]"
                + ".[Portland].[Store 11]}\n"
                + "{[Product].[Product].[Drink].[Alcoholic Beverages].[Beer and Wine].[Beer].[Top Measure], [Store].[USA].[OR]"
                + ".[Portland].[Store 11]}\n"
                + "{[Product].[Product].[Drink].[Alcoholic Beverages].[Beer and Wine].[Beer].[Walrus], [Store].[USA].[OR].[Portland]"
                + ".[Store 11]}\n"
                + "Row #0: 5\n"
                + "Row #0: 1\n"
                + "Row #1: 3\n"
