...
class DrilldownMemberFunDefTest {
    ...
    void testDrilldownMember(Context context) {
        ...
        assertAxisReturns(context.getConnectionWithDefaultRole(), "Sales",
            ...
            "{[Store Type].[Store Type].[Supermarket], [Store].[USA]}\n"
                + "{[Store Type].[Store Type].[Supermarket], [Store].[USA].[CA]}\n"
                + "{[Store Type].[Store Type].[Supermarket], [Store].[USA].[OR]}\n"
                + "{[Store Type].[Store Type].[Supermarket], [Store].[USA].[WA]}" );
    }
