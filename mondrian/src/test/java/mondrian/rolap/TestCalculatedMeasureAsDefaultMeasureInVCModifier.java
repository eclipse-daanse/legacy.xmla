...
public class TestCalculatedMeasureAsDefaultMeasureInVCModifier implements CatalogMappingSupplier {
    ...
    public TestCalculatedMeasureAsDefaultMeasureInVCModifier(Catalog baseCatalog) {
        ...
        VIRTUAL_CUBE_SALES_VS_WAREHOUSE.setDefaultMeasure((org.eclipse.daanse.rolap.mapping.model.olap.dimension.hierarchy.level.MemberLike) copier.get(CatalogSupplier.CALCULATED_MEMBER_PROFIT));
