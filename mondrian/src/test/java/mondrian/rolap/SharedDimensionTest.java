...
class SharedDimensionTest  {
    ...
    private static final String resultNECJMemberList =
        ...
        + "{[Measures].[Employee Store Sales]}\n"
        + "Axis #2:\n"
        + "{[Store Type].[Store Type].[Deluxe Supermarket], [Employee].[Store Management]}\n"
        + "{[Store Type].[Store Type].[Gourmet Supermarket], [Employee].[Store Management]}\n"
        + "{[Store Type].[Store Type].[Mid-Size Grocery], [Employee].[Store Management]}\n"
        + "{[Store Type].[Store Type].[Small Grocery], [Employee].[Store Management]}\n"
        + "{[Store Type].[Store Type].[Supermarket], [Employee].[Store Management]}\n"
        + "Row #0: $61,860\n"
        + "Row #1: $10,156\n"
        + "Row #2: $10,212\n"
        + "Row #3: $5,932\n"
