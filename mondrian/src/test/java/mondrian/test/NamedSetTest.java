...
class NamedSetTest {
    ...
    void testNamedSetUsedInCrossJoin(Context context) {
        assertQueryReturns(context.getConnectionWithDefaultRole(),
            ...
            + "{[Time].[Time].[1997].[Q2]}\n"
            + "Axis #2:\n"
            + "{[Promotion Media].[Promotion Media].[No Media], [Product].[Drink]}\n"
            + "{[Promotion Media].[Promotion Media].[No Media], [Product].[Food]}\n"
            + "{[Promotion Media].[Promotion Media].[No Media], [Product].[Non-Consumable]}\n"
            + "{[Promotion Media].[Promotion Media].[Daily Paper, Radio, TV], [Product].[Drink]}\n"
            + "{[Promotion Media].[Promotion Media].[Daily Paper, Radio, TV], [Product].[Food]}\n"
            + "{[Promotion Media].[Promotion Media].[Daily Paper, Radio, TV], [Product].[Non-Consumable]}\n"
            + "{[Promotion Media].[Promotion Media].[Daily Paper], [Product].[Drink]}\n"
            + "{[Promotion Media].[Promotion Media].[Daily Paper], [Product].[Food]}\n"
            + "{[Promotion Media].[Promotion Media].[Daily Paper], [Product].[Non-Consumable]}\n"
            + "{[Promotion Media].[Promotion Media].[Product Attachment], [Product].[Drink]}\n"
            + "{[Promotion Media].[Promotion Media].[Product Attachment], [Product].[Food]}\n"
            + "{[Promotion Media].[Promotion Media].[Product Attachment], [Product].[Non-Consumable]}\n"
            + "{[Promotion Media].[Promotion Media].[Cash Register Handout], [Product].[Drink]}\n"
            + "{[Promotion Media].[Promotion Media].[Cash Register Handout], [Product].[Food]}\n"
            + "{[Promotion Media].[Promotion Media].[Cash Register Handout], [Product].[Non-Consumable]}\n"
            + "Row #0: 3,970\n"
            + "Row #0: 4,287\n"
            + "Row #1: 32,939\n"
            + "Row #1: 33,238\n"
    ...
    void testContextSensitiveNamedSet(Context context) {
        ...
        assertQueryReturns(context.getConnectionWithDefaultRole(),
            ...
            + "{[Measures].[California sales for Top Media]}\n"
            + "Axis #1:\n"
            + "{[Store].[Store].[All Stores], [Time].[1997].[Q1]}\n"
            + "{[Store].[Store].[All Stores], [Time].[1997].[Q2]}\n"
            + "{[Store].[Store].[USA].[CA], [Time].[1997].[Q1]}\n"
            + "{[Store].[Store].[USA].[CA], [Time].[1997].[Q2]}\n"
            + "Axis #2:\n"
