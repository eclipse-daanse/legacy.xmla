...
//        discard();
    ...
    private void assertAxisWithDimensionPrefix(Connection connection, boolean prefixNeeded) {
        ...
        TestUtil.assertAxisReturns(connection, "Sales", "[Gender].[Gender].[M]", "[Gender].[M]");
        TestUtil.assertAxisReturns(connection, "Sales", "[Gender].[Gender].[All Gender].[M]", "[Gender].[M]");
        TestUtil.assertAxisReturns(connection, "Sales", "[Store].[Store].[USA]", "[Store].[USA]");
        TestUtil.assertAxisReturns(connection, "Sales", "[Store].[Store].[All Stores].[USA]", "[Store].[USA]");
    }
