...
class IgnoreUnrelatedDimensionsTest {
    ...
    void testPartiallyRelatedMeasureWithCompoundSlicer(Context context) {
        ...
        assertQueryReturns(context.getConnectionWithDefaultRole(),
            ...
            + "  {[Warehouse].[USA].[WA], [Warehouse].[USA].[CA]} )",
            "Axis #0:\n"
            + "{[Education Level].[Education Level].[Graduate Degree], [Warehouse].[USA].[WA]}\n"
            + "{[Education Level].[Education Level].[Graduate Degree], [Warehouse].[USA].[CA]}\n"
            + "{[Education Level].[Education Level].[High School Degree], [Warehouse].[USA].[WA]}\n"
            + "{[Education Level].[Education Level].[High School Degree], [Warehouse].[USA].[CA]}\n"
            + "Axis #1:\n"
            + "{[Measures].[bothCubes]}\n"
            + "Row #0: 157,936\n");
    }
